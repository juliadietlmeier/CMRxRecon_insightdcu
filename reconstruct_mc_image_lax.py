...
def reconstruct_mc_image_lax(path, accfactor):
    ...
    for t in range(0,timeframe):
        for k in range(0,sz):
            for c in range(0,sc):
                ...
                state_dict = torch.load("/home/daa/Desktop/CMRxRecon_challenge_MICCAI23/Python_submission/denoisingUNET_300epochs_MC_lax.pt")
