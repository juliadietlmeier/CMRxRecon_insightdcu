...
def reconstruct_mc_image_sax_v2(path, accfactor):
    ...
    state_dict = torch.load("/home/daa/Desktop/CMRxRecon_challenge_MICCAI23/Python_submission/MC_GNAUnet_300epochs_sax.pt")
    ...
    return recon_arr#rss(recon_arr,dim=2)
...
#RA=reconstruct_mc_image_sax_v2(src_file, 'AccFactor04')
